...
public class ButtonsListener extends JFrame implements ActionListener  {
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(command.equals("ConvertCurrencies")){
            ...
            if(CheckBoxListener.whatSelected == 1){
                ClientGui.dollarConverterField.setText("" + rubles / Currencies.USD);
                ClientGui.euroConverterField.setText("" + rubles / Currencies.EUR);
            }else if(CheckBoxListener.whatSelected == 2){
                ClientGui.rublesConverterField.setText("" + dollars * Currencies.USD);
                ClientGui.euroConverterField.setText("" + dollars/(Currencies.EUR/Currencies.USD));
            }else if(CheckBoxListener.whatSelected == 3){
                ClientGui.rublesConverterField.setText("" + euros * Currencies.EUR);
                ClientGui.dollarConverterField.setText("" + euros/(Currencies.USD/Currencies.EUR));
            }
