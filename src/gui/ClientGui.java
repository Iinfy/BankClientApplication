...
public class ClientGui{
    ...
    public static JLabel errorLabel = new JLabel("No error");



    //Buttons
    public static JButton homePageButton = new JButton(new ImageIcon("icons/homePageIcon.png"));
    public static JButton converterPageButton = new JButton(new ImageIcon("icons/converterPageIcon.png"));
    ...
    public void start(){
        ...
        rubleCheckBox.addItemListener(CheckBoxListener);
        rubleCheckBox.setBackground(Color.cyan);
        dollarCheckBox.setBounds(185,155,20,20);
        dollarCheckBox.addItemListener(CheckBoxListener);
        dollarCheckBox.setBackground(Color.cyan);
        euroCheckBox.setBounds(185,205,20,20);
        euroCheckBox.addItemListener(CheckBoxListener);
        euroCheckBox.setBackground(Color.cyan);
